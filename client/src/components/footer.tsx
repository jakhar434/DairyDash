      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-sm text-muted-foreground mb-4">
              Premium dairy products and artisanal condiments, sourced from local farms and crafted with care.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-2">
                ...
                <span className="text-sm text-muted-foreground">hello@pureharvest.com</span>
              </li>
              <li className="flex items-start gap-2">
        ...
        <div className="mt-8 pt-8 border-t text-center">
          <p className="text-sm text-muted-foreground">
            © {new Date().getFullYear()} Pure Harvest. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
